...
import { addEventListener } from "../util/getScrollTop";
...
class Trigger extends React.Component {
  ...
  renderComponent(componentArg, ready) {
    const instance = this;
    const isVisible = instance.state.popupVisible;

    if (!isVisible || instance._component || isVisible(instance)) {
      if (!instance._container) {
        instance._container = instance.getContainer(instance);
      }
      let component;
  ...
  onPopupMouseLeave = (e) => {
    ...
    if (e.relatedTarget && !e.relatedTarget.setTimeout &&
          this._component &&
          this._component.getPopupDomNode().contains(e.relatedTarget)) {
      return;
    }
    this.delaySetPopupVisible(false, this.props.mouseLeaveDelay);
  }
